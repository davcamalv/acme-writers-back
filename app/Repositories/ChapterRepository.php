...
class ChapterRepository {
    ...
    public function save(array $data){
        ...
        return new ChapterDto($chapter->id, $chapter->title, $chapter->number, $chapter->text, new BookSimpleDto($book->id, $book->title, $book->draft));
    }
    ...
    public function listChaptersOfBook(int $book_id){
        ...
        foreach($chapters as $chapter){
            $chapter_dto = new ChapterDto($chapter->id, $chapter->title, $chapter->number, $chapter->text, new BookSimpleDto($book->id, $book->title, $book->draft));
    ...
    public function update(array $data){
        ...
        $chapter->save();
        return new ChapterDto($chapter->id, $chapter->title, $chapter->number, $chapter->text,new BookSimpleDto($chapter->book->id, $chapter->book->title, $chapter->book->draft));
