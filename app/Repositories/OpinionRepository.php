...
class OpinionRepository {
    ...
    public function findOne(int $opinion_id){
        ...
        return new OpinionDto($opinion->id, $opinion->positive, $opinion->review, $opinion->date, $book->id, new BasicUserDto($opinion->user->name, $opinion->user->photo));
    ...
    public function listOpinionsOfBook(int $book_id){
        ...
        foreach($opinions as $opinion){
            $opinion_dto = new OpinionDto($opinion->id, $opinion->positive, $opinion->review, $opinion->date, $opinion->book->id, new BasicUserDto($opinion->user->name, $opinion->user->photo));
    ...
    public function update(array $data){
        ...
        $opinion->save();
        return new OpinionDto($opinion->id, $opinion->positive, $opinion->review, $opinion->date, $opinion->book->id, new BasicUserDto($opinion->user->name, $opinion->user->photo));
    }
